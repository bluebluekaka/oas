                ...
                $(function ()
                {
	                ...
	                $("#framecenter").ligerTab({ 
	                	...
	                	onAfterSelectTabItem:function(tabid){
	                		...
	                		if('home1'==tabid){
	                			url+="transfer_rl=1&order_state=0&transfer_ck=<%=Config.STATE_NEW%>";
	                		}else if('home2'==tabid){
	                			url+="transfer_rl=1&order_state=0&transfer_ck=<%=Config.STATE_AUDIT_ING%>";
	                		}else if('home3'==tabid){
	                			url+="transfer_rl=1&order_state=0&transfer_ck=<%=Config.STATE_AUDIT_SUC%>&transfer_usable=<%=Config.STATE_USABLE_YES%>";
	                		}else if('home4'==tabid){
	                			url+="transfer_rl=1&order_state=0&transfer_ck=<%=Config.STATE_AUDIT_FAIL%>";
	                		}else if('home5'==tabid){
	                			url+="transfer_rl=1&order_state=0&transfer_ck=<%=Config.STATE_AUDIT_SUC%>&transfer_usable=<%=Config.STATE_USABLE_NO%>";
	                		}else if('home6'==tabid){
	                			url+="transfer_rl=1&order_state=1&transfer_ck=&transfer_usable=";
	                		}else{
	                			url+="transfer_rl=0&transfer_ck=&order_state=&transfer_usable=";
	                		}
    ...
    <body style="padding:2px">  
      <div id="layout1">
            <div position="center"  id="framecenter" >
	            ...
	            <div tabid="home6" title="作废" style="height:300px" >
