...
<head>
    ...
    $(function () {  
			...
			$("#producttype").ligerGetComboBoxManager().setValue(<%=Config.ORDER_TYPE_ALL%>);
	  		$("form").ligerForm();
            ...
            function(json) 
            {
                ...
                for(var i in json.Rows[0])  
                {
                        ...
                        if(i=='HideID') 
                        	hides = ',hide:true';
                        colnames+=",{name:'"+i+"',display:'"+i+"',width: 95" + hides+"}";
                }
	...
	function f_inputUser(){
		$.ligerDialog.open({ target: $("#target1"),title:'<%=title%>',height: 200,width: 800,isResize: true,showMax:true, 
			buttons: [
			{ text: '确定', 
				onclick: function (item, dialog) {
					 location.href = '<%=jspName%>?stime='+ $("#stime").val()
					 	+'&etime='+$("#etime").val()+'createuser='+ $("#createuser").val()
					 	+'&type='+$("#type").val()+'&producttype='+ $("#producttype").val()
...
<div id="target1" style="displiay:none" >
  <table height="72" cellpadding="0" cellspacing="0" class="l-table-edit" >
    <tr>
    	...
    	<td align="left" class="l-table-edit-td"><input type="text" id="stime" name="stime" /></td>
    	<td align="right" class="l-table-edit-td">开始时间:</td>
  	  	<td align="left" class="l-table-edit-td"><input type="text" id="etime" name="etime" /></td>
		<td align="right" class="l-table-edit-td">业务员:</td>
      <td align="left" class="l-table-edit-td"><input type="text" id="createuser" name="query.createuser" value="" /></td>
	</tr>
    <tr>
      <td align="right" class="l-table-edit-td">订单类型:</td>
      <td align="left" class="l-table-edit-td"><input name="query.type" type="text" id="type" ltype="text"  value="" /></td>
      <td align="right" class="l-table-edit-td">产品类型:</td>
      <td align="left" class="l-table-edit-td"><input name="query.producttype" id="producttype" ltype="text" value="" /></td>
      <td align="right" class="l-table-edit-td">产品名称:</td>
      <td align="left" class="l-table-edit-td"><input type="text" id="productname" name="query.productname" value="" /></td>      
    </tr>
</table> 
 </div>
</form> 
