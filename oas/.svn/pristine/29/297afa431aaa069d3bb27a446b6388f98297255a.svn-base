...
<head><title>
    ...
    <script type="text/javascript"> 
    	...
    	function getID(){
			var qurl = 'order_list.jsp?query=true';
...
<tr>
              ...
              <td align="left" class="l-table-edit-td"><input name="order.orderid" id="orderid" ltype="text" value="" /></td>
              <td align="left"></td>
              <td  class="l-table-edit-td"><input type="button" value="选择订单" id="Button2" class="l-button l-button-submit" onclick="getID()" /></td>
